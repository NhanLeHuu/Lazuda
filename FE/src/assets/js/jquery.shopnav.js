...
$(document).ready(() => {
  setTimeout(() => {
    $.fn.shopNav = function (options) {
      ...
      var mode
      var tabInit = false
      var $toggleBtn = $element.find('.toggle-button')
      var $closeSpan = $element.find('.ah-close')
      var $underneathSpanToggle = $element.find('.has-dropdown').children('.js-menu-toggle')
      var $megaBtn; var $megaMenuItem; var $megaMenuSpan; var $megaMenuContent
