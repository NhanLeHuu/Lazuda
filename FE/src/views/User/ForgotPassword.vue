              ...
              <div class="col-lg-6 col-md-8 u-s-m-b-30">
                <div class="l-f-o">
                  <div class="l-f-o__pad-box">
                    <h1 class="gl-h1">RESET MẬT KHẨU</h1>

                    <span class="gl-text u-s-m-b-30"
                      >Nhập email hoặc tên người dùng của bạn vào bên dưới và chúng tôi 
                      sẽ gửi cho bạn một liên kết để đặt lại mật khẩu của bạn. </span
                    >
                    <form class="l-f-o__form">
                      ...
                      <div class="u-s-m-b-30">
                        <router-link class="gl-link" to="login">Trở Về Đăng Nhập</router-link>
                      </div>
                    </form>
                  </div>
                </div>
