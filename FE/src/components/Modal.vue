                  ...
                  <div class="pd-wrap">
                    <div id="js-product-detail-modal">
                      ...
                      <div v-for="(item,index) in 5" :key="index">
                        <img
                          class="u-img-fluid"
                          src="@/assets/product/product-d-1.jpg"
                          alt=""
                        />
                      </div>
                  ...
                  <div class="u-s-m-t-15">
                    <div id="js-product-detail-modal-thumbnail">
                      <div>
                        <img
                          class="u-img-fluid"
                          src="../assets/product/smartphone/vsmart-1.jpg"
                          alt=""
                        />
                      </div>
                      <div>
                        <img
                          class="u-img-fluid"
                          src="../assets/product/smartphone/vsmart-2.jpg"
                          alt=""
                        />
                      </div>
                      <div>
                        <img
                          class="u-img-fluid"
                          src="@/assets/product/product-d-3.jpg"
                          alt=""
                        />
                      </div>
                      <div>
                        <img
                          class="u-img-fluid"
                          src="@/assets/product/product-d-4.jpg"
                          alt=""
                        />
                      </div>
                      <div>
                        <img
                          class="u-img-fluid"
                          src="@/assets/product/product-d-5.jpg"
                          alt=""
                        />
                      </div>
                    </div>
                ...
                <div class="pd-detail">
                  ...
                  <div>
                    <div class="pd-detail__inline">
                      ...
                      <span class="pd-detail__discount">({{ detail.discount }}% OFF)</span
                  ...
                  <div class="u-s-m-b-15">
                    ...
                    <ul class="pd-detail__policy-list">
                      ...
                      <li>
                        ...
                        <span
                          >Full Refund if you don't receive your order.</span
                        >
                      </li>
                      <li>
                        <i class="fas fa-check-circle u-s-m-r-8"></i>
                        ...
                        <span
                          >Returns accepted if product not as described.</span
                        >
                      </li>
                    </ul>
                  </div>
              ...
              <div class="col-lg-6 col-md-12">
                <div class="success u-s-m-b-30">
                  ...
                  <div class="success__img-wrap">
                    <img
                      class="u-img-fluid"
                      src="@/assets/product/electronic/product1.jpg"
                      alt=""
                    />
                  </div>
                  <div class="success__info-wrap">
                    <span class="success__name"
                      >Beats Bomb Wireless Headphone</span
                    >
...
export default {
  ...
  watch: {
    detail: {
      deep: true,
      handler (val) {
        var wrapper = $('.slick-slide')
        for (var i = 0; i < wrapper.length; i++) {
          var img = $(wrapper[i]).children()
          console.log(img)
          img[0].src = val.galley[0]
