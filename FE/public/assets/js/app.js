...
$(document).ready(() => {
  setTimeout(() => {
    ...
    var $collectionOfFilterBtn = $('.filter__btn')
    var $primarySlider = $('#hero-slider')
    var $testimonialSlider = $('#testimonial-slider')
    var $collectionaClickScroll = $('[data-click-scroll]')
    var $collectionProductSlider = $('.product-slider')
    var $collectionTabSlider = $('.tab-slider')
    var $collectionInputCounter = $('.input-counter')
    var $collectionCountDown = $('[data-countdown]')
    var $collectionCartModalLink = $('[data-modal="modal"]')
    var $defaultAddressCheckbox = $('#get-address')
    var $collectionFormBill = $('[data-bill]')
    var $collectionPostGallery = $('.post-gallery')
    var $blogMasonry = $('.blog-m')
    var $collectionPostVideo = $('.post-video-block')
    // $("iframe[src*="youtube"], iframe[src*="vimeo"]") jQuery Multiple Selector
    var $collectionEmbedVideo = $('iframe[src*="youtube"]')
    var $productDetailElement = $('#pd-o-initiate')
    var $productDetailElementThumbnail = $('#pd-o-thumbnail')
    var $modalProductDetailElement = $('#js-product-detail-modal')
    var $modalProductDetailElementThumbnail = $('#js-product-detail-modal-thumbnail')
    var $shopCategoryToggleSpan = $('.shop-w__category-list .has-list > .js-shop-category-span'); var // Recursive
      $shopGridBtn = $('.js-shop-grid-target')
    var $shopListBtn = $('.js-shop-list-target')
    var $shopPerspectiveRow = $('.shop-p__collection > div')
    var $shopFilterBtn = $('.js-shop-filter-target')
